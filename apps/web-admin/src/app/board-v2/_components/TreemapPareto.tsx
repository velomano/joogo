      ...
      chartRef.current = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [{
            ...
            backgroundColor: chartData.map((_, index) => Object.values(colorPalette)[index % Object.keys(colorPalette).length]),
            borderColor: chartData.map((_, index) => Object.values(colorPalette)[index % Object.keys(colorPalette).length]),
            borderWidth: 1
          }]
        },
        options: {
