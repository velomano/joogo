-- 18단계: 모든 함수 완전 삭제 후 재생성

-- 1. 모든 함수들을 CASCADE로 완전 삭제
drop function if exists public.board_sales_daily() cascade;
drop function if exists public.board_sales_daily(date,date,text[],text[],text[],text[]) cascade;
drop function if exists public.board_roas_by_channel() cascade;
drop function if exists public.board_roas_by_channel(date,date,text[],text[],text[],text[]) cascade;
drop function if exists public.board_top_categories() cascade;
drop function if exists public.board_top_categories(date,date,text[],text[],text[],text[]) cascade;
drop function if exists public.board_top_regions() cascade;
drop function if exists public.board_top_regions(date,date,text[],text[],text[],text[]) cascade;
drop function if exists public.board_top_skus() cascade;
drop function if exists public.board_top_skus(date,date,text[],text[],text[],text[]) cascade;

drop function if exists analytics.board_sales_daily(date,date,text[],text[],text[],text[]) cascade;
drop function if exists analytics.board_roas_by_channel(date,date,text[],text[],text[],text[]) cascade;
drop function if exists analytics.board_top_categories(date,date,text[],text[],text[],text[]) cascade;
drop function if exists analytics.board_top_regions(date,date,text[],text[],text[],text[]) cascade;
drop function if exists analytics.board_top_skus(date,date,text[],text[],text[],text[]) cascade;
